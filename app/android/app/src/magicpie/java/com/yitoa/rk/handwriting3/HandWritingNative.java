...
/**
 * Minimal ABI bridge independently written for the public Magicpie system library.
 *
 * <p>The package, class, callback names, and native descriptors match the JNI
 * registration table verified by the repository's standalone probe. No native
 * binary is bundled with Butterfly.</p>
 */
@Keep
public final class HandWritingNative {
    ...
    private static void postJpegDataFromNative(Object reference, byte[] jpegData) {
        // Required by the library's JNI lookup; this integration does not use it.
    }
