...
- [ ] P10：AC672368 主程序用户确认流畅、不消失、粗细实时显示；输入缓冲兼容、history补齐、连续原生会话、同步逐采样笔宽已实机观察。普通测试131项、相关诊断27项通过。保存重开/撤销重做/笔宽设置与缩放一致性仍在验收，不能将所有P10子项勾完。见 NATIVE-INTEGRATION-VERIFICATION.md。
