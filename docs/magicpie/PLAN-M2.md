...
- [ ] P9：用户确认 be464f52e 恢复版“可以，没有问题”；20 次 stop/destroy/init/start、退后台返回、force-stop 重启完成，未发现崩溃。新增 Android D/M/U 计数版已装机，等待连续笔画核对；输入完整性、显示恢复和文档交接尚未验收。见 PROBE-VERIFICATION.md。
- [ ] P10：仅在 P9 Go 时执行。
