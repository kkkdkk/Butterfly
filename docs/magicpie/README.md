...
- [PNG命令行导出](../../tools/bfly-export/README.md)：本地 `.bfly → PNG`、按页/Area批处理、原稿哈希保护、使用命令与验收边界。
- [AI识别路线](AI-INGEST-PLAN.md)：GitHub电脑版安装检查点、PNG→Codex→Markdown/Mermaid路线、已实现的导出入口与后续识别边界。
